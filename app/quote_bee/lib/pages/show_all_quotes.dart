...
class ShowAllQuotes extends StatelessWidget {
  const ShowAllQuotes({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future:
            Provider.of<QuoteProvider>(context, listen: false).selectData(0),
